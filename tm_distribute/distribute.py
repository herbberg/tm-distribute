...
class ObjectHelper(object):
    Types = {
        ...
        tmEventSetup.MBT0HFP: 'minimumbias',
        tmEventSetup.MBT1HFP: 'minimumbias',
        tmEventSetup.MBT0HFM: 'minimumbias',
        tmEventSetup.MBT1HFM: 'minimumbias',
        tmEventSetup.ASYMET: 'asymmetry',
        tmEventSetup.ASYMHT: 'asymmetry',
        tmEventSetup.ASYMETHF: 'asymmetry',
        tmEventSetup.ASYMHTHF: 'asymmetry',
